...
const (
	AppName          string = "FPSelfHegdeAPIGo"
	SuccessMsg       string = "Success"
	ERR_CODE_SUCCESS string = "0"
	SuccessCode      string = "0"
	SuccessCode200   string = "200"
	ERR_CODE_ICE_API string = "900001"
)
...
const (
	ProductTypeSelfHedge = "SelfHedge"
)

const (
	FinantcialProduct = "Finantcial Product"
)
